# DevOS
full IDE inside a browserDevOS - Developer Operating System
Project Overview
...
Tab-Based UX: Each function (Editor, Terminal, Git, Supervisor) gets its own tab instead of cramming everything into one screen
Supervisor Pattern: Comet/Perplexity acts as an always-on reviewer that intervenes when code deviates from best practices
Agent-Based Architecture: Multiple specialized agents (Supervisor, Code Consultant, Test Consultant) work together
System Components
...
Intervention Types
Critique: Points out contract violations or anti-patterns
Patch Proposals: Structured diffs for auto-apply
Guardrails: Blocks dangerous operations before execution
Agent Communication
...
Local Development: Work in appropriate subdirectory (Mobile, server, etc.)
Testing: Test changes locally before committing
Agent Testing: Validate agent prompts and responses
Client Testing: Test on actual devices/browsers for mobile and web support
Integration: Ensure clients and backend communicate properly
